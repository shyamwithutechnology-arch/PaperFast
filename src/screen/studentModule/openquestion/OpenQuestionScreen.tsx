...
//     const [showSolution, setShowSolution] = useState(false);
//     const [answers, setAnswers] = useState<Record<string, string>>({});
//     console.log('selectedOptioncurrentQIndex', selectedOption, answers);
...
//     console.log('selectedOptionwwwww', selectedOption, showSolution);
...
//         navigation.goBack()
//     }
//     console.log('chaperName',selectedOption === currentQuestion.correct_option);
...
const OpenQuestionScreen = () => {
    ...
    const handleFinishTest = () => {
        ...
        questions.forEach(question => {
            ...
            console.log('userAnswerwwww', userAnswer);
