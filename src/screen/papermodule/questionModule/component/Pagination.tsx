...
//             <Pressable style={styles.paginationBox} onPress={handleLabelStatus}>
//                 <Text style={[styles.totalText, { fontSize: moderateScale(13.5) }]}>{total}{" "}</Text>
//                 <Image
//                     source={Icons.downArrow}
//                     style={[
//                         styles.arrow,
//                         { transform: [{ rotate: rangeStatus ? "180deg" : "0deg" }] },
//                     ]}
//                 />
//             </Pressable>
//             {rangeStatus === true && <View style={styles.randDropDownBox}>
//                 <Text style={styles.limitText}>25</Text>
//                 <Text style={styles.limitText}>50</Text>
//                 <Text style={styles.limitText}>75</Text>
...
//                         ←
//                     </Text> */}
//                     <LeftIcons name="chevron-back-outline" size={moderateScale(14)} color={page === 1 ? '#ccc' : '#000'} />
//                 </TouchableOpacity>
