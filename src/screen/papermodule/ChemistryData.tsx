...
//     const handleQuestoinListPasination = async () => {
//         setLoader(true)
//         try {
//             let params = {
//                 'subject_id': '6',
...
//                 'limit': '10'
//             }
//             let res = await POST_FORM(ApiEndPoint?.Question, params)
...
//             <AppHeader title='sdafadsf' onBackPress={() => { }} />
//             <Text style={{ color: '#000', fontStyle: moderateScale(20) }}>ChemistryData component</Text>
//         </SafeAreaView>
//     )
// }
